...
import Dog1P from '../../assets/img/dog1P.png';
import Dog2D from '../../assets/img/dog2D.png';
import Dog2M from '../../assets/img/dog2M.png';
import Dog2P from '../../assets/img/dog2P.png';
  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.wrapForma}>
         ...
         <p className={styles.text}>Welcome! Please enter your credentials to login to the platform:</p>
         <LoginReactForma/>
